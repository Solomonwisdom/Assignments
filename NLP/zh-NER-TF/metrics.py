...
if __name__ == '__main__':
    ...
    for filename in ['dev']:
        with open('data_path/{}.prediction.txt'.format(filename)) as f:
            predictions = [line.strip().split() for line in f.readlines()]
        with open('data_path/{}.tags.txt'.format(filename)) as f:
            gold_labels = [line.strip().split() for line in f.readlines()]
